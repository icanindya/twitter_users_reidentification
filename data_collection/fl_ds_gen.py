'''
Dataset: FL voter records 2018-10-15 snapshot.
...
FL_BASE_PATH = r'D:\Data\Linkage\FL\FL18\20181015_VoterDetail'
...
for item in os.listdir(FL_BASE_PATH):
    item_path = os.path.join(FL_BASE_PATH, item)
    if os.path.isfile(item_path):
        with open(item_path, 'r') as rf:

            with open(os.path.join(FL_EXT_PATH, item), 'w') as wf:
